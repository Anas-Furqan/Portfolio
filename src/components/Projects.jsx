...
const projects = [
  ...
  },
  {
    ...
    description: 'Modern e-commerce UI using React and integrating Hexashop template into a MERN stack.',
    tech: ['React', 'HTML', 'CSS', 'JS'],
    image: '/projects/hexashop.png',
